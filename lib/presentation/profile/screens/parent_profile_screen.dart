...
/// Màn hình Cá nhân dành cho phụ huynh.
...
class _ParentProfileScreenState extends State<ParentProfileScreen> {
  ...
  Widget _buildBody(BuildContext context, ThemeData theme, bool isDark) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          // ── Avatar + Tên + Vai trò (card nền riêng) ──
          _buildProfileHeader(theme, isDark, cardColor, borderColor),
          const SizedBox(height: 8),

          // ── Học sinh liên kết ──
          _buildLinkedStudentsSection(theme, isDark, cardColor, borderColor),
  ...
  /// Header: Avatar lớn + edit button + tên + vai trò.
  /// Nền card trắng/dark với shadow + border-bottom.
        ...
        children: [
          ...
          Stack(
            children: [
              ...
              // Edit button → mở trang chỉnh sửa
              Positioned(
                bottom: 0,
                right: 0,
  ...
  /// Section: Học sinh liên kết — grid 2 cột.
  Widget _buildLinkedStudentsSection(
    ThemeData theme,
    bool isDark,
    Color cardColor,
    Color borderColor,
  ) {
    final children = widget.controller.linkedUsers;
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildStudentCard(
                  ...
                  onTap: () => _showLinkedUserDetail(context, child, true),
                );
              },
            ),
        ],
  ...
  /// Card học sinh liên kết — giống HTML design.
  ...
  /// Section: Cài đặt chung — grouped card with dividers.
  ...
  /// Section: Thông báo — card with toggle.
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        Text(
                          'Nhận thông báo khi con check-in',
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.grey[500],
                          ),
                  ...
                  Transform.scale(
                    ...
                    child: Switch(
                      ...
                      onChanged: (value) {
                        setState(() => _notifyBoardAlighting = value);
                      },
                      activeColor: theme.colorScheme.primary,
                    ),
                  ),
  ...
  /// Section: Tài khoản — grouped card + version footer.
  ...
  /// Row item cho settings/account — icon bg + label + chevron.
