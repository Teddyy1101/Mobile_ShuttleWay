...
/// Màn hình đặt vé xe buýt dành cho Học sinh.
class StudentBookTicketScreen extends StatefulWidget {
  final TicketController ticketController;
  final ProfileController profileController;
  final PaymentController paymentController;

  const StudentBookTicketScreen({
    super.key,
  ...
  @override
  State<StudentBookTicketScreen> createState() =>
      _StudentBookTicketScreenState();
}

class _StudentBookTicketScreenState extends State<StudentBookTicketScreen> {
        ...
        builder: (context, _) {
          return Column(
            children: [
              ...
              Expanded(
                child: widget.ticketController.isLoading
      ...
      builder: (ctx) {
        return DraggableScrollableSheet(
          ...
          builder: (context, scrollController) {
            return _StudentRouteSearchSheet(
              routes: routes,
              theme: theme,
              isDark: isDark,
  ...
  Widget _buildDateCard({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        width: 70,
        padding:
            const EdgeInsets.symmetric(vertical: AppConstants.paddingSM + 4),
        decoration: BoxDecoration(
          color: isSelected
              ? theme.colorScheme.primary
        ...
        child: Column(
          children: [
            ...
            if (selectedRoute != null)
              Padding(
                padding: const EdgeInsets.only(
                    bottom: AppConstants.paddingMD + 4),
                child: Wrap(
...
/// Widget tìm kiếm tuyến đường cho BottomSheet (Student booking).
class _StudentRouteSearchSheet extends StatefulWidget {
  ...
  const _StudentRouteSearchSheet({
  ...
  @override
  State<_StudentRouteSearchSheet> createState() =>
      _StudentRouteSearchSheetState();
}

class _StudentRouteSearchSheetState extends State<_StudentRouteSearchSheet> {
